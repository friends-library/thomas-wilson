[short="Epistles by Thomas Wilson and James Dickenson"]
...
But when they joined themselves unto Baal of Peor, the Lord`'s wrath was kindled against them,
...
[.blurb]
=== To Friends of Mountmellick, Men`'s Meeting, and Elsewhere.
